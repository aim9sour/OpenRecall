...
export const OPTIMIZER_TRAINING_MANIFEST = {
  ...
  capabilities: [
    ...
    { key: "convertCsvToFsrsItems", classification: "tool" },
    { key: "wasiLoader", classification: "internal" },
    { key: "bindingConstructors", classification: "internal" },
    { key: "evaluationHelpers", classification: "tool" },
    { key: "sm2Migration", classification: "tool" },
  ],

interface FixtureStatement {
  run(parameters: Record<string, number | string | null>): unknown;
}

export interface StatisticsFixtureDatabase {
  exec(source: string): unknown;
  prepare(source: string): FixtureStatement;
}

export const SECTION_ONE = "d9428888-122b-41e1-985c-61cd3cbb3210";
export const SECTION_TWO = "e9428888-122b-41e1-985c-61cd3cbb3210";
export const ITEM_ONE = "a8f65aa8-122b-41e1-985c-61cd3cbb3210";
export const ITEM_TWO = "18f65aa8-122b-41e1-985c-61cd3cbb3210";
export const ITEM_THREE = "28f65aa8-122b-41e1-985c-61cd3cbb3210";
export const ITEM_FOUR = "38f65aa8-122b-41e1-985c-61cd3cbb3210";

export function seedStatisticsFixture(
  db: StatisticsFixtureDatabase,
): void {
  ...
  db.exec(`
    ...
    VALUES
      ...
      ('${ITEM_TWO}', '${SECTION_ONE}', 'active', 0, 0, NULL),
      ('${ITEM_THREE}', '${SECTION_TWO}', 'trashed', 0, 0, 100),
      ('${ITEM_FOUR}', '${SECTION_TWO}', 'active', 0, 0, NULL);
    ...
    VALUES
      ...
      ('p2', '${ITEM_TWO}', 'primary', 0, 'Q2', 'A2', NULL, 'Q2', 'A2', 'active'),
      ('p3', '${ITEM_THREE}', 'primary', 0, 'Q3', 'A3', NULL, 'Q3', 'A3', 'active'),
      ('p4', '${ITEM_FOUR}', 'primary', 0, 'Q4', 'A4', NULL, 'Q4', 'A4', 'active');
    ...
    VALUES
      ...
      ('p2', ${t3}, ${t3}, 1, 'session-1', '${ITEM_TWO}'),
      ('p3', ${t4}, ${t4}, 1, 'session-2', '${ITEM_THREE}'),
    ...
    VALUES
      ...
      (
        '${ITEM_TWO}', '${SECTION_ONE}', ${Date.parse("2025-01-17T00:00:00Z")},
        'learning', 0, 1, 6, 0, 0, ${t3}, 1, 0, 1,
        'FSRS-6', '6.0', 1, 'official-fsrs6-v1'
      ),
      (
        '${ITEM_THREE}', '${SECTION_TWO}', ${Date.parse("2025-01-25T00:00:00Z")},
        'relearning', 0, 2, 7, 1, 1, ${t4}, 4, 2, 4,
        'FSRS-6', '6.0', 1, 'official-fsrs6-v1'
      ),
      (
        '${ITEM_FOUR}', '${SECTION_TWO}', ${Date.parse("2025-01-18T00:00:00Z")},
    ...
    VALUES
      ...
      ('q3', 'session-1', '${ITEM_TWO}', 'completed', ${t3}, ${t3}, ${t3}, 'p2', ${t3}, ${t3}, ${t3}),
      ('q4', 'session-2', '${ITEM_THREE}', 'completed', ${t4}, ${t4}, ${t4}, 'p3', ${t4}, ${t4}, ${t4});
  `);

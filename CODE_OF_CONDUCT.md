...
`abdullahmansour.marketing@gmail.com`. Do not include unrelated private study
data. Community moderators will take reports seriously, investigate them in a
timely manner, and prioritize safety and confidentiality.
...
Lower rungs may be skipped for serious violations.

1. **Warning:** a private written warning, with repair such as an apology, acknowledgement of responsibility, or clarification of expectations.
2. **Temporarily limited activities:** a time-limited cooldown from specified interactions, with conditions for thoughtful re-entry.
3. **Temporary suspension:** removal from community spaces for a defined period, with explicit conditions for return.
4. **Permanent ban:** removal from all community spaces when lesser measures cannot keep the community safe.

This ladder is a guideline and does not limit moderator discretion exercised in

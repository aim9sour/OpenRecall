...
1. نزّل `OpenRecall-v1.0.0-windows-x64.zip` من أحدث إصدار، ثم فك الملف كله
...
وأغلق التطبيق بـ`Ctrl+C` وانتظر اكتمال الإغلاق الآمن لقاعدة SQLite. يفتح
Chrome إن كان متاحًا، وإلا يستخدم المتصفح الافتراضي.
...
- كشف التطابق التام قبل استيراد JSON، وإعادة تسمية القسم وحذفه نهائيًا، وسلة
  البطاقات واستعادتها وحذفها، والسمات، وRTL/LTR، وغلاف PWA قابل للتثبيت.
...
والاتصالات الخارجة، ولا يخزن PWA ردود API أو نصوص البطاقات في مخزنه التشغيلي،
ولا تسجل التشخيصات محتوى البطاقات.
